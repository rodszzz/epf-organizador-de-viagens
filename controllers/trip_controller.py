...
class TripController(BaseController):
    ...
    def __init__(self, app):
        super().__init__(app)
        self.app.route('/trips', method='GET',
                       callback=self.login_required(self.list_trips))
        self.app.route('/trips/delete/<trip_idx:int>', method='GET',
                       callback=self.login_required(self.delete_trip))
