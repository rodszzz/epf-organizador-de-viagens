...
class UserController(BaseController):
    def __init__(self, app):
        ...
        self.app.route('/account', method='GET',
                       callback=self.login_required(self.show_account))
        self.app.route('/account', method='POST',
                       callback=self.login_required(self.update_account))

    def show_account(self):
        """ Mostra o formulário com os dados do utilizador logado. """
        user_id = int(request.get_cookie(
